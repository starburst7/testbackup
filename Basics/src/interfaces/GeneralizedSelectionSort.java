...
public class GeneralizedSelectionSort {
	...
	//NOTE:  Notice our parameter says it accepts any class that implements a Comparable interface.
	//        
	//       Since String,Double, Integer can all implement Comparable. This means that each of them
	//        have already CLEARLY defined methods compareTo().
	
	//     => Thus, we are free to use any of them as parameters.
