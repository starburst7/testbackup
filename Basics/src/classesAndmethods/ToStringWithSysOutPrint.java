...
public class ToStringWithSysOutPrint {
	...
	return ("Coordinates of point are ("   + x +   ", "  + y +   ")");    //x,y are the instance variables of the object that is calling this method.
	}																	//  note the objects below are p1 and p2
																		//using system out print implicitly calls the toString method.
